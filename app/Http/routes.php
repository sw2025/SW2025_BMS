...
//编辑操作人员
Route::get('/edit_operator/{userId}','LoginController@editOperator');
//保存编辑操作人员
Route::post('/edit_operatorSave','LoginController@editOperatorSave');
//删除操作人员
Route::get('/delete_operator/{userId}','LoginController@deleteOperator');
//重置密码
Route::get('/reset_operator/{userId}','LoginController@resetOperator');
//角色权限
Route::get('/role','RoleController@index');
//查看权限
Route::get('/look_right/{roleId}','RoleController@lookRight');
//添加角色
Route::get('/add_role','RoleController@addRole');
//保存角色
Route::post('/add_roleSave','RoleController@addRoleSave');
//修改角色
Route::get('/edit_role/{roleId}','RoleController@editRole');
//保存修改角色
Route::post('/edit_roleSave','RoleController@editRoleSave');
//保存修改角色
Route::get('/delete_role/{roleId}','RoleController@deleteRole');
/******************************审核操作*************************************************/
//企业审核
...
//企业信息维护详情
Route::get('/serve_enterpriseDet/{enterpriseId}','EnterpriseController@serveDetail');
//专家维护
