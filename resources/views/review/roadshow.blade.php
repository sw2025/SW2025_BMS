                        ...
                        <div class="container-fluid cert-item">
                            <div class="col-md-10 cert-border">
                                <div class="container-fluid">
                                    <div class="col-md-4">
                                        <h2 class="cert-company"><a href="{{asset('/roadShowdetail/'.$v->roadshowid)}}" class="look-link">{{$v->enterprisename}}</a></h2>
                                    ...
                                    <p class="cert-zone" style="float: right;color:black;"><b>提交时间：{{$v->roadtime}}</b></p>
