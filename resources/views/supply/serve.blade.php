            ...
            <div class="section-body change-pwd">
                ...
                <div class="cert-list" >
                    ...
                    <div class="container-fluid cert-item">
                        <div class="col-md-4">
                            <h2 class="cert-company"><a href="{{url('/serve_supplyDet',$v->needid)}}" class="look-link">【{{$v->needtype}}】@if(!empty($v->enterprisename)) {{$v->enterprisename}} @else {{$v->expertname}} @endif</a></h2>
