        ...
        <section>
            ...
            <div class="section-body contain-lg change-pwd">
                <div class="container-fluid details-bg">
                    <div class="col-md-12 details-tit"><h1 class="cert-company">【{{$datas->needtype}}】@if(!empty($datas->expertname)){{$datas->expertname}} @else {{$datas->enterprisename}} @endif</h1></div>
                ...
                @foreach($result as $big)
                    ...
                    @foreach($result as $small)
                        ...
                        <p class="details-tit details-desc"><span style="font-size: 14px;font-weight: bold;">楼中楼：</span>{{$datas->content}}</p>
