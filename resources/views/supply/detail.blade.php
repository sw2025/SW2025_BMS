        ...
        <section>
            ...
            <div class="section-body contain-lg change-pwd">
                <div class="container-fluid details-bg">
                    <div class="col-md-12 details-tit"><h1 class="cert-company">{{$datas->expertname or $datas->enterprisename}}</h1></div>
                ...
                <div class="container-fluid details-bg">
                    <p class="details-tit details-desc"><span style="font-size: 14px;font-weight: bold;">企业/专家介绍：</span>{{$datas->desc1 or $datas->desc2}}</p>
                </div>
                <div class="container-fluid details-bg">
