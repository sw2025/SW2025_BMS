                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-outlined">
                        <div class="box-head tac">
                            <h4 class="text-light tac">新增会员信息</h4>
                        </div>
                        <div class="box-body no-padding">
                            <form class="form-horizontal form-bordered form-validate" role="form" novalidate="novalidate" action="{{url('dealaddmember')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-9">
                                        <input type="text" name="termtime" id="timelimit" class="form-control" placeholder="请输入年限" required="" data-rule-minlength="1" value="">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-9">
                                        <input type="text" name="cost" id="fees" class="form-control" placeholder="请输入会费" required="" value="">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-9">
                                        <input type="text" name="consultcount" id="consults" class="form-control" placeholder="请输入咨询次数" data-rule-minlength="1" required="" value="">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-9">
                                        <input type="text" name="eventcount" id="worksCount" class="form-control" placeholder="请输入办事次数" data-rule-minlength="1" required="" value="">
                                    </div>
                                    <span class="col-lg-1 col-sm-1 line-hei" style="line-height:32px;">次</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-9">
                                        <textarea name="rightbrief"  placeholder="请输入权益描述" required=""  class="form-control" rows="3"></textarea>
                                    </div>
                                </div>
