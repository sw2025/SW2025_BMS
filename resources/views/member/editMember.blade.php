                        ...
                        <div class="box-body no-padding">
                            <form class="form-horizontal form-bordered form-validate" role="form" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-9">
                                        <input type="text" name="timelimit" id="timelimit" class="form-control" placeholder="请输入年限" required="" data-rule-minlength="1" value="1">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-9">
                                        <input type="text" name="fees" id="fees" class="form-control" placeholder="请输入会费" required="" value="3000">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-9">
                                        <input type="text" name="consults" id="consults" class="form-control" placeholder="请输入咨询次数" data-rule-minlength="1" required="" value="10">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-9">
                                        <input type="text" name="worksCount" id="worksCount" class="form-control" placeholder="请输入办事次数" data-rule-minlength="1" required="" value="10">
                                    </div>
                                    <span class="col-lg-1 col-sm-1 line-hei" style="line-height:32px;">次</span>
                                </div>
