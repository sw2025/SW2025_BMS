    ...
    <div id="content">
        ...
        <section>
            ...
            <div class="section-body change-pwd">
                <div class="col-md-12">
                    <p class="tac add-tit"><a href="{{asset('/role')}}">返回</a></p>
                    <div class="box box-outlined">
                        <div class="box-head tac">
                            <h4 class="text-light">新增或修改角色信息</h4>
                        </div>
                        <div class="box-body no-padding">
                            <form class="form-horizontal form-bordered form-validate" role="form" novalidate="novalidate" method="post" action="{{asset('add_roleSave')}}">
                                <div class="form-group">
                                    <div class="col-lg-3 col-sm-2">
                                        <label for="name" class="control-label">请输入角色</label>
                                    </div>
                                    <div class="col-lg-9 col-sm-10">
                                        <input type="text" name="name" id="name" class="form-control" placeholder="请输入角色" required="" data-rule-minlength="2" value="{{old('name')}}">
                                    </div>
                                </div>
