        ...
        <section>
            ...
            <div class="section-body contain-lg change-pwd">
                <div class="container-fluid details-bg">
                    ...
                    <div class="col-md-6 details-tit"><p class="cert-industry">需求分类：{{$datas->domain1}}-{{$datas->domain2}}-------------{{$result->name}}</p></div>
                ...
                @foreach($expertData as $value)
                    <div class="container-fluid details-bg">
                        ...
                        <div class="col-md-6 details-tit"><p class="cert-industry">专家状态：{{$value->state}}</p></div>
                    </div>
                @endforeach
