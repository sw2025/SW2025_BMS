        ...
        <ul class="clearfix">
            <li class="item col-md-3 col-xs-6"><a href="javascript:;">
                    ...
                    <div class="item-con-hover">
                       <p><br /><span  class="supplyShow" style="font-size: 1.5em;">项目评议</span><br /><br /><br /><span class="linemeet" style="font-size: 1.5em;">约见投资人</span><br /><br /><br /><span class="hatch" style="font-size: 1.5em;">线下路演</span><br /><br /></p>
                    </div>
                </a></li>
            <li class="item col-md-3 col-xs-6"><a href="javascript:;">
                    ...
                    <div class="item-con-hover">
                        <p><br /><span style="font-size: 1.5em;" class="meetdav">约见大V</span><br /><br /><br /><span style="font-size: 1.5em;" class="onlinevideo">线上私董会</span><br /><br /><br /></p>
                    </div>
                </a></li>
            <li class="item col-md-3 col-xs-6"><a href="javascript:;">
...
<script>
                ...
                if(res['code']=="success"){
                    $.each(res['msg'],function(key,value){
                        var str=" <li class=''>";
                            ...
                            str+="<span class='expert-consult'>视频咨询：已开启</span></div><div class='ex-res-con-desc'>"
  ...
  /*  $('.item-con-hover span').on('click',function () {
    ...
    $('.linemeet').click(function () {
        window.location.href="{{asset('expert')}}?role=专家&ordertime=desc&supply=投融资/天使投资&meetdav=2";
    })

    $('.hatch').click(function () {
        if($.cookie('userId')){
            window.location.href="{{asset('uct_myneed2/roadShow')}}";
        }else{
            window.location.href="/login?returnurl={{asset('/uct_myneed2/roadShow')}}";
        }
    })

    $('.onlinevideo').click(function () {
        if(!$.cookie('userId')){
            window.location.href="/login?returnurl={{asset('/uct_video/applyVideo')}}?meet=privateBoard"
            return false;
        } else {
            window.location.href="{{asset('/uct_video/applyVideo')}}?meet=privateBoard";
        }
    })
    $('.meetdav').click(function () {
    	layer.open({
                                type: 1,
                                skin: 'layui-layer-rim', //加上边框
                                shadeClose: false, //开启遮罩关闭
                                content: '<div style="padding:10px;">请选择约见的行业分类</div>',
                                btn: ['风险投资','项目融资','市场拓展','战略运营'],
                                yes: function(index, layero){
                                    window.location.href="{{asset('expert')}}?role=专家&ordertime=desc&supply=投融资/风险投资&meetdav=1";
                                },btn2: function(index, layero){
                                    window.location.href="{{asset('expert')}}?role=专家&ordertime=desc&supply=投融资/项目融资&meetdav=1";
                                },btn3: function(index, layero){
                                    window.location.href="{{asset('expert')}}?role=专家&ordertime=desc&supply=市场资源/&meetdav=1";
                                },btn4: function (index, layero){
                                    window.location.href="{{asset('expert')}}?role=专家&ordertime=desc&supply=战略管理/&meetdav=1";
                                }
                            });
    	return false;
    })
    $('.supplyShow').click(function () {
        ...
        if(!$.cookie('userId')){
            window.location.href="/login?returnurl={{asset('/uct_myshow/supplyShow')}}"
            return false;
        } else {
            window.location.href="{{asset('/uct_myshow/supplyShow')}}";
        }
    })
